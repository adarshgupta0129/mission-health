	...
	function pixudio_distortionEffect() {
		...
		var set = function set(scope, i) {
			...
			var options = {
				...
				displacementImage: scope.getAttribute("data-mask") || base_url+"assets/front/assets/media/mask/ripple.jpg",
		...
		if (false === PIXI) {
			...
			script.onload = init;
			script.async = true;
			script.src = base_url+"assets/front/assets/js/pixi.js";
	...
	function pixudio_googleMap() {
		...
		var initMap = function initMap() {
			var set = function set(canvas) {
				...
				var icon = JSON.parse(canvas.getAttribute("data-icon")) || { url: base_url+"assets/front/assets/media/icon/map-marker.svg", size: { width: 72, height: 72 } };
